System.config({
  ...
  bundles: {
    "app-build.js": [
      ...
      "factorio-service.js",
      "main.js",
      "map-generator/map-generator.html!github:systemjs/plugin-text@0.0.8.js",
      "map-generator/map-generator.js",
      "resources/index.js",
      "save-files/blob-to-url.js",
      "save-files/file-list-to-array.js",
      "save-files/save-files.html!github:systemjs/plugin-text@0.0.8.js",
      "save-files/save-files.js",
      "server-settings/server-settings.html!github:systemjs/plugin-text@0.0.8.js",
      "server-settings/server-settings.js",
      "style.css!github:systemjs/plugin-text@0.0.8.js"
    ],
    "aurelia.js": [
      ...
      "npm:pace-progress@1.0.2.js",
      "npm:pace-progress@1.0.2/pace.js"
    ]
  },
  depCache: {
    "api-client.js": [
